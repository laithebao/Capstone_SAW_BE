...
public interface ISupplierRepository
{
    ...
    Task AddSupplierAsync(Supplier supplier, List<int> cropTypeIds, List<SupplierCertificationInputDto> certifications, CancellationToken cancellationToken = default);
    ...
    Task UpdateSupplierAsync(Supplier supplier, List<int> cropTypeIds, List<SupplierCertificationInputDto> certifications, string oldValuesJson, CancellationToken cancellationToken = default);
